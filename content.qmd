---
title: "A Bayesian hierarchical model of categorical data rating and classification"
author:
  - name: "Bob Carpenter"
    corresponding: true
...
date: last-modified
description: |
  This is a paper to be submitted to the journal *Computo*.
abstract: >+
...
keywords: [crowdsourcing, Bayesian modeling, hierarchical priors, categorical data]
citation:
